...
from langchain_community.embeddings import XinferenceEmbeddings  # pip install xinference -i https://mirrors.aliyun.com/pypi/simple/
...
print("docs[0].page_content[:500]:",docs[0].page_content[:500])
...
print("Store:=================================================")
bgeM3Embeddings = XinferenceEmbeddings(
    server_url="http://0.0.0.0:38445",
